...
- **キーワードブロック**: 指定した語を含む動画も非表示(初期設定は空)
...
4. Safari で下記URLを開き、表示されたコードを全選択してコピーする
   <https://raw.githubusercontent.com/S-hashima1/youtube-shorts-hider/main/userscript/youtube-shorts-hider.user.js>
